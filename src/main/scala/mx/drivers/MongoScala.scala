...
object MongoScala {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val mongoClient: MongoClient = MongoClient("mongodb://10.15.191.150:27017")
    val database: MongoDatabase = mongoClient.getDatabase("tst")
    val collection: MongoCollection[Document] = database.getCollection("pruebas")
